...
namespace Cyggie.Main.Runtime.ServicesNS
{
    ...
    public abstract class ServiceMono : IService
    {
        ...
        internal void OnApplicationFocus_Internal() => OnApplicationFocus();

        internal void OnApplicationPause_Internal(bool pause) => OnApplicationPause(pause);

        internal void OnApplicationQuit_Internal() => OnApplicationQuit();
        ...
        /// <summary>
        /// This function is called when the application is focused on
        /// </summary>
        protected virtual void OnApplicationFocus() { }

        /// <summary>
        /// This function is called when the application is paused / unpaused
        /// </summary>
