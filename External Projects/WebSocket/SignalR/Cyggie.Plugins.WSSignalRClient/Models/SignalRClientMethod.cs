...
namespace Cyggie.Plugins.SignalR
{
    /// <summary>
    /// Base Model for a WS Client method
    /// </summary>
    public class SignalRClientMethod
    {
        ...
        public SignalRClientMethod(Action callback)
        {
            ...
            Callback = (object?[] objs) =>
            {
                if (objs.Length != 0)
                {
                    Log.Error($"Provided number of arguments not the same as required. Received {objs.Length}, expected {ParameterTypes.Length}", nameof(SignalRClientMethod));
                    return;
                }
...
#pragma warning restore CS8603 // Possible null reference return.
    ...
    public class WSClientMethod<T1> : SignalRClientMethod
    {
        /// <summary>
...
#pragma warning restore CS8604 // Possible null reference argument.
    ...
    public class WSClientMethod<T1, T2> : SignalRClientMethod
    {
        /// <summary>
...
#pragma warning restore CS8604 // Possible null reference argument.
    ...
    public class WSClientMethod<T1, T2, T3> : SignalRClientMethod
    {
        /// <summary>
...
#pragma warning restore CS8604 // Possible null reference argument.
    ...
    public class WSClientMethod<T1, T2, T3, T4> : SignalRClientMethod
    {
        /// <summary>
...
#pragma warning restore CS8604 // Possible null reference argument.
    ...
    public class WSClientMethod<T1, T2, T3, T4, T5> : SignalRClientMethod
    {
        /// <summary>
...
#pragma warning restore CS8604 // Possible null reference argument.
    ...
    public class WSClientMethod<T1, T2, T3, T4, T5, T6> : SignalRClientMethod
    {
        /// <summary>
...
#pragma warning restore CS8604 // Possible null reference argument.
    ...
    public class WSClientMethod<T1, T2, T3, T4, T5, T6, T7> : SignalRClientMethod
    {
        /// <summary>
...
#pragma warning restore CS8604 // Possible null reference argument.
    ...
    public class WSClientMethod<T1, T2, T3, T4, T5, T6, T7, T8> : SignalRClientMethod
    {
        /// <summary>
